...
from api_client import fetch_email_credentials
...
def process_keys(
    ...
    try:
        ...
        items = fetch_email_credentials(codes)
...
def main():
    ...
    process_keys(codes, args.format, args.headless, proxy, args.flaresolverr_url)
